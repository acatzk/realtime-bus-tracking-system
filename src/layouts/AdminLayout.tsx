...
import { BsCardChecklist, BsCalendar2Date } from 'react-icons/bs'
...
const AdminLayout: NextPage<Props> = ({ children, metaTitle }): JSX.Element => {
...
const Header = (): JSX.Element => {
  ...
  const dashboardLink = [
    ...
    { name: 'Daily Schedules', href: 'schedules', Icon: BsCalendar2Date }
  ]
