...
//   const { data } = await nhost.graphql.request(GET_TRACKERS_IDs)
//   console.log(data)

//   return {
//     paths: data?.data?.trackers?.map(({ id }) => ({
//       params: {
//         id
//       }
//     })),
...
const DriverMap: NextPage = () => {
  ...
  // useEffect(() => {
  //   console.log(setLatitude(data?.data?.trackers?.latitude))
  //   console.log(setLongitude(data?.data?.trackers?.longitude))
  // })

  // if (isFallback) return <>Loading map...</>
  // if (!isFallback && !data) return <>No such map found!</>
      ...
      <main className="h-screen w-full relative bg-gray-100">
        ...
        <iframe
          src={classNames(
            ...
            'Pintuyan%2C%20Southern%20Leyte!3m2!1d9.99513!2d125.2258365!4m5!1s0x330711c59ca30769%3A0x2a3fd238fb08613c!2sDr.%20Gonzalo%20Yong%20Memorial%20Bus%20Terminal%2C%20Osme%C3%B1a%20Street%2C%20Sogod%2C%206606%20',
            ...
            `Maasin%20City%2C%20Southern%20Leyte!3m2!1d10.132173!2d124.83481409999999!4m4!2s10.3440045%2C124.8668659!3m2!1d${latitude}!2d${longitude}!5e0!3m2!1sen!2sph!4v1652595733458!5m2!1sen!2sph`
          )}
          width="100%"
          loading="lazy"
