      ...
      <div className="flex items-center justify-center px-4 h-screen min-h-screen bg-white dark:bg-dark-dim text-gray-800 transition ease-in-out duration-700">
        <div className="flex flex-col items-center space-y-4">
          <div className="flex items-center">
            <h1 className="font-bold text-9xl -mr-6 dark:text-gray-800">4</h1>
            ...
            <h1 className="font-bold text-9xl -ml-8 dark:text-gray-800">4</h1>
          </div>
          <div className="flex flex-col items-center">
            <h2 className="text-xl uppercase font-semibold dark:text-gray-800">
              Oops! Page not be found
            </h2>
            <div className="max-w-md text-center">
              <p className="text-gray-500 text-sm dark:text-gray-700">
